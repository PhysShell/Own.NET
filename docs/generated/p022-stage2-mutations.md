...
Definition: `docs/evidence/p022-stage2-1.json` (sha256 `ab355418652628cc…`, 11 mutations). Replay on a clean tree with `python scripts/mutate_campaign.py --campaign docs/evidence/p022-stage2-1.json --run`; the recorded run is raw outcomes and provenance, the counts below are derived from it.

| measure                                          | value |
|--------------------------------------------------|---|
| recorded at commit                               | `e02e209251c338dd771dffad94758c215a7f0727` |
