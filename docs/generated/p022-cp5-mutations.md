<!-- GENERATED by scripts/render_checkpoint_status.py from docs/evidence/p022-cp5-1.json, docs/evidence/p022-cp5-2.json and their .result.json. Do not edit: regenerate with `python scripts/render_checkpoint_status.py`; tests/run_tests.py fails while this file is stale. -->
