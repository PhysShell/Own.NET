...
| [P-024](P-024-security-audit-profile.md) | Security audit profile (external tools + SARIF adapters; rejects own scanner engine) | in progress (v0.1 built: `audit/security/` profile + adapters + runner) |
