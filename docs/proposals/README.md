...
| [P-026](P-026-dispatcher-task-continuation-leaks.md) | Dispatcher/Task continuation capture leak (`WPF006`) — closures escaping to Dispatcher/TPL infrastructure | draft |
