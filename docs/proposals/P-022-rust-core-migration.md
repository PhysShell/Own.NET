...
built and replaying on both platforms (row 7b), so the queue moved past it —
the owner closes #261 by hand after review, and that is a bookkeeping step
rather than remaining work. In parallel and off the critical chain: #257, #263
