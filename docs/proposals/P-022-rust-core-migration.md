...
**Preferred queue:** the coordinate-domain decision → #259 final acceptance →
#260 acceptance / #261. Both cp5 and 4b are off this queue: each is complete at
its surface, and the one thing #259's final acceptance still needs is the
contract decision on coordinates. The #260/#269
