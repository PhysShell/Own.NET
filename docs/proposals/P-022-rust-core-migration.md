...
**Preferred queue:** 4b (protocol analysis) → the coordinate-domain decision →
#259 final acceptance → #260 acceptance / #261. cp5 is off this queue: it is
complete at its surface, and what #259's final acceptance still needs is the
protocol family and the contract decision on coordinates. The #260/#269
