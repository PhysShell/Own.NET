...
that note and the bakeoff's raw evidence live on branch
`claude/p036-capability-bakeoff-fzw74t` at `ce2e6bc` and were deliberately
NOT ported into this tree; see `docs/notes/p037-formal-kernel.md` §9):
